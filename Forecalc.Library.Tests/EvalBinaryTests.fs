...
[<Test>]
let ``Null^Null -> Pow(Null, Null) -> ErrorValue("#NUM!")``() =
    let workbook = QT4.create<CellContent>()
    let cell = { Sheet = "Sheet1" ; Row = 1 ; Col = 1 }
...
[<Test>]
let ``Null^0.0 -> Pow(Null, 0.0) -> ErrorValue("#NUM!")``() =
    let workbook = QT4.create<CellContent>()
    let cell = { Sheet = "Sheet1" ; Row = 1 ; Col = 1 }
...
[<Test>]
let ``0.0^Null -> Pow(0.0, Null) -> ErrorValue("#NUM!")``() =
    let workbook = QT4.create<CellContent>()
    let cell = { Sheet = "Sheet1" ; Row = 1 ; Col = 1 }
...
[<Test>]
let ``Null^false -> Pow(Null, false) -> ErrorValue("#NUM!")``() =
    let workbook = QT4.create<CellContent>()
    let cell = { Sheet = "Sheet1" ; Row = 1 ; Col = 1 }
...
[<Test>]
let ``false^Null -> Pow(false, Null) -> ErrorValue("#NUM!")``() =
    let workbook = QT4.create<CellContent>()
    let cell = { Sheet = "Sheet1" ; Row = 1 ; Col = 1 }
...
[<Test>]
let ``0.0^0.0 -> Pow(0.0, 0.0) -> ErrorValue("#NUM!")``() =
    let workbook = QT4.create<CellContent>()
    let cell = { Sheet = "Sheet1" ; Row = 1 ; Col = 1 }
